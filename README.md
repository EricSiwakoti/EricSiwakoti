...
<p align="center">
  <a href="https://github.com/EricSiwakoti">
    <img src="https://skillicons.dev/icons?i=aws,bash,docker,express,figma,firebase,git,githubactions,go,grafana,graphql,js,jest,kafka,kubernetes,linux,lua,md,mongodb,neovim,nextjs,nginx,nodejs,postgres,postman,prisma,prometheus,rabbitmq,react,redis,redux,tailwind,ts,vscode" />
  </a>
</p>
